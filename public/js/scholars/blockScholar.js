...
function UpdateBlockModal(fullname, email, userId){
        ...
        <span class="small">Scholar Name:</span>
        <h6 class="mb-3">${fullname}</h6>
        <!-- Email -->
        <span class="small">Scholar Email id:</span>
        <h6 class="mb-3">${email}</h6>

        <!-- Summary -->
        <span class="small">NOTE:</span>
        <p class="text-dark mb-2">Completing this process will block this scholar from the ASFIScholar platform, ADMIN can unblock later.</p>
